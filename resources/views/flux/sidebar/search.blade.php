...
$classes = Flux::classes()
    ->add('h-10 py-2 px-3 w-full border rounded-lg block disabled:shadow-none appearance-none text-base sm:text-sm leading-[1.375rem] bg-zinc-800/5 text-zinc-700 placeholder-zinc-500 disabled:placeholder-zinc-400 border-0 relative flex gap-3')
