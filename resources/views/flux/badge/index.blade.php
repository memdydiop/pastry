...
@php
    ...
    $classes = Flux::classes()
        ...
        ->add(match ($size) {
            ...
            'sm' => 'text-xs leading-5 py-1 **:data-flux-badge-icon:size-3 **:data-flux-badge-icon:me-1',
        })
        ->add(match ($variant) {
        ...
        ->add($variant === 'solid' ? match ($color) {
            ...
            'primary' => 'text-white bg-primary/70 [&:is(button)]:hover:bg-primary',
            'secondary' => 'text-white bg-secondary/70 [&:is(button)]:hover:bg-secondary',
            'info' => 'text-white bg-info/70 [&:is(button)]:hover:bg-info',
            'success' => 'text-white bg-success/70 [&:is(button)]:hover:bg-success',
            'danger' => 'text-white bg-danger/70 [&:is(button)]:hover:bg-danger',
        } :  match ($color) {
